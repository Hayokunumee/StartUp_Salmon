...
st.markdown("<h1 style = 'color: #86469C; text-align: center; font-size: 60px; font-family: Helvetica'>STARTUP PROFIT PREDICTOR APP</h1>", unsafe_allow_html = True)
...
#Add an Image
st.image('pngwing.com.png', width = 600, caption = 'Created By Ayokunumi')
